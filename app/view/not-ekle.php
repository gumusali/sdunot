	...
	<body>
		...
		<div class="container minHeight">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="fakulte" id="fakulte" class="form-control" required>
									  <option value="" disabled selected>Fakülte seçin</option>
									  <?php
									  		foreach($fakulteler as $f) {
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="donem" id="donem" class="form-control" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="file">
										...
										<input name="dosya" style="display: none" id="dosya" class="form-control" type="file" required />
										<div class="clear"></div>
			...
			<?php
					...
					echo "<div class='alert alert-info'>Not eklemek için giriş yapın</div>";
				}
			?>
		</div>
